 ...
 *
 */
public class AccountTransferBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public AccountTransferBusinessDelegate()  {
	...
	*
	* @return 	AccountTransferBusinessDelegate
	*/
	public static AccountTransferBusinessDelegate getAccountTransferInstance() {
		return( new AccountTransferBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of AccountTransfer {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of AccountTransfer {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of AccountTransfer {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(AccountTransferBusinessDelegate.class.getName());
