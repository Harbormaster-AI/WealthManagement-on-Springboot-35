 ...
 *
 */
public class InvestmentProgramBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public InvestmentProgramBusinessDelegate()  {
   ...
   /**
	* InvestmentProgram Business Delegate Factory Method
	*
	* All methods are expected to be self-sufficient.
	*
	* @return 	InvestmentProgramBusinessDelegate
	*/
	public static InvestmentProgramBusinessDelegate getInvestmentProgramInstance() {
		return( new InvestmentProgramBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of InvestmentProgram {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of InvestmentProgram {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of InvestmentProgram {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(InvestmentProgramBusinessDelegate.class.getName());
