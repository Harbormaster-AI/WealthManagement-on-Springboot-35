 ...
 *
 */
public class RebalancePlanBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public RebalancePlanBusinessDelegate()  {
	...
	*
	* @return 	RebalancePlanBusinessDelegate
	*/
	public static RebalancePlanBusinessDelegate getRebalancePlanInstance() {
		return( new RebalancePlanBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of RebalancePlan {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of RebalancePlan {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of RebalancePlan {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(RebalancePlanBusinessDelegate.class.getName());
