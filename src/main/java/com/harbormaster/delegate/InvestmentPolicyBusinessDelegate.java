 ...
 *
 */
public class InvestmentPolicyBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public InvestmentPolicyBusinessDelegate()  {
	...
	*
	* @return 	InvestmentPolicyBusinessDelegate
	*/
	public static InvestmentPolicyBusinessDelegate getInvestmentPolicyInstance() {
		return( new InvestmentPolicyBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of InvestmentPolicy {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of InvestmentPolicy {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of InvestmentPolicy {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(InvestmentPolicyBusinessDelegate.class.getName());
