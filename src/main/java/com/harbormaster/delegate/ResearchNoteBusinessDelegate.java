 ...
 *
 */
public class ResearchNoteBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public ResearchNoteBusinessDelegate()  {
	...
	*
	* @return 	ResearchNoteBusinessDelegate
	*/
	public static ResearchNoteBusinessDelegate getResearchNoteInstance() {
		return( new ResearchNoteBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of ResearchNote {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of ResearchNote {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of ResearchNote {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(ResearchNoteBusinessDelegate.class.getName());
