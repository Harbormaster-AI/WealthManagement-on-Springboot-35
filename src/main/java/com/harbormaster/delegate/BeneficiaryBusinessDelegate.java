...
//************************************************************************
     ...
     * Default Constructor 
     */
    public BeneficiaryBusinessDelegate()  {
	...
	*
	* @return 	BeneficiaryBusinessDelegate
	*/
	public static BeneficiaryBusinessDelegate getBeneficiaryInstance() {
		return( new BeneficiaryBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of Beneficiary {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of Beneficiary {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of Beneficiary {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(BeneficiaryBusinessDelegate.class.getName());
