...
public class TransactionEntityProjector implements EntityProjector<Transaction>{
     ...
     * @return	Transaction
     */
    public Transaction assignOrder( UUID parentId, Order assignment ) {
    ...
    public Transaction find( UUID id ) {
    	...
    	try {
    		...
    		LOGGER.log( Level.WARNING, "Failed to find a Transaction - {0}", exc.getMessage() );
    	}
    	return null;
    }
    ...
    public List<Transaction> findAll( FindAllTransactionQuery query ) {
    	...
    	try {
    		...
    		LOGGER.log( Level.WARNING, "Failed to find all Transaction - {0}", exc.getMessage() );
    	}
    	return null;
    }
    ...
    private static final Logger LOGGER 	= Logger.getLogger(TransactionEntityProjector.class.getName());
