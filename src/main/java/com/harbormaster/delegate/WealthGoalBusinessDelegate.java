 ...
 *
 */
public class WealthGoalBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public WealthGoalBusinessDelegate()  {
	...
	*
	* @return 	WealthGoalBusinessDelegate
	*/
	public static WealthGoalBusinessDelegate getWealthGoalInstance() {
		return( new WealthGoalBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of WealthGoal {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of WealthGoal {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of WealthGoal {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(WealthGoalBusinessDelegate.class.getName());
