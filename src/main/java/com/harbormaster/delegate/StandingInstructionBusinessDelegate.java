 ...
 *
 */
public class StandingInstructionBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public StandingInstructionBusinessDelegate()  {
	...
	*
	* @return 	StandingInstructionBusinessDelegate
	*/
	public static StandingInstructionBusinessDelegate getStandingInstructionInstance() {
		return( new StandingInstructionBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of StandingInstruction {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of StandingInstruction {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of StandingInstruction {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(StandingInstructionBusinessDelegate.class.getName());
