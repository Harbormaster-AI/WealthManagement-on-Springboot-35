 ...
 *
 */
public class ModelPortfolioBusinessDelegate 
...
//************************************************************************
     ...
     * Default Constructor 
     */
    public ModelPortfolioBusinessDelegate()  {
   ...
   /**
	* ModelPortfolio Business Delegate Factory Method
	*
	* All methods are expected to be self-sufficient.
	*
	* @return 	ModelPortfolioBusinessDelegate
	*/
	public static ModelPortfolioBusinessDelegate getModelPortfolioInstance() {
		return( new ModelPortfolioBusinessDelegate() );
	}
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "done creating of ModelPortfolio {0} ", entity.toString() );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
    	...
    	try {       
			...
			LOGGER.log( Level.INFO, "done saving of ModelPortfolio {0} ", entity.toString() );
    	}
        catch (Exception exc) {
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
    	...
    	try {  
        	...
        	LOGGER.log( Level.INFO, "done deleting of ModelPortfolio {0} ", id );
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(ModelPortfolioBusinessDelegate.class.getName());
